...
PIPELINE_DIR = os.path.join("data", "pipelines")
...
def write_pipeline_file(pipeline_data, filename):
    """Writes a pipeline dictionary to a JSON file."""
        ...
        if "eval_data" in bench_data and isinstance(bench_data["eval_data"], list):
            ...
            for question in bench_data["eval_data"]:
                ...
                if pipeline:
                    ...
                    write_pipeline_file(pipeline, filename)
        else:
